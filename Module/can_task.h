...
{	
	...
	fp32 Capacity;			//���ݵ�ѹ���ŵ�3V��Ȼ��3v->6V����ٴηŵ磩*100
...
typedef struct{
	...
	uint16_t offecd_ecd;              //���ָ����̨��ǰ���ľ�������ֵ
	fp32 target_angle;                //ת����Ҫת���ĽǶ�
	fp32 given_voltage;               //���͸�����ĵ���ֵ  ��Χ [-30000,30000]
